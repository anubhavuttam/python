...
files = os.listdir("C:/Users/Kakashi/Desktop/python/Clutter")
i = 1
for file in files:
    if file.endswith(".png"):
        print(file)
        os.rename(f"C:/Users/Kakashi/Desktop/python/Clutter/{file}" , f"C:/Users/Kakashi/Desktop/python/Clutter/{i}.png")
        i = i + 1